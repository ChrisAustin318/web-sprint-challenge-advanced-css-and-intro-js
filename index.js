...
console.log(changeName(artists, 8, 'Vincent Van Dough'))
...
function get20s(dataOne, dataTwo){
    for (i = 0; i <= array.length; i++)
    if(array[i].years >= dataOne && <= dataTwo){
      return [array.name];
    }
}
...
function addArtist(array){
    array.push({
      ...
      'bio': 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque maximus nec ante eu volutpat. Pellentesque sodales congue urna sit amet laoreet. Aenean interdum lorem magna. Sed luctus enim ut nulla gravida, vitae condimentum sapien tristique. Phasellus facilisis, nisi non facilisis volutpat, orci erat luctus arcu, nec pharetra arcu orci sed dolor. Sed lacus quam, iaculis sed ultrices sit amet, ullamcorper quis massa. Sed ullamcorper tellus vulputate urna blandit, at sodales lacus faucibus. Duis feugiat lorem vitae lacus vehicula efficitur. Integer tempus nulla hendrerit condimentum dapibus. Suspendisse id libero non diam interdum consectetur sed vitae ex. Vestibulum pulvinar ipsum pellentesque ultricies venenatis.'
    })
      return array.push;
  }
